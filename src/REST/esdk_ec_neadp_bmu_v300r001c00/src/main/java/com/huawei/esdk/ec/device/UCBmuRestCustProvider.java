...
public class UCBmuRestCustProvider extends AbstractProtocolAdatperCustProvider
{
        ...
        throws ProtocolAdapterException
    {
        ...
        if (null != res && null != resObjClass)
        {
            Object body = null;
            try
            {
                if (0 <= payload.indexOf("paramlist"))
                {
