...
public abstract class AbstractBMUCapability
{
    ...
    public AbstractBMUCapability(ISDKProtocolAdapter protocolAdapter)
    {
        ...
        throws ProtocolAdapterException
    {
        ...
        {
            // 连续多次调用接口，会出现接口调用不通的异常，返回错误码2130000010
            String devId = ConfigManager.getInstance().getValue("esdk.ec_bmu_device");
            
            synchronized (AbstractBMUCapability.class)
            {
