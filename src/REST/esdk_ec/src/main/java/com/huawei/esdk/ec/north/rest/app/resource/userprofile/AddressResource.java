...
public class AddressResource
{
    ...
    public QueryAddressResponse queryAddrList(@QueryParam("account") String account, 
        ...
        @QueryParam("pageNum") String pageNum)
    {
        ...
        try
        {
            ...
            SDKResult<AddressListInfo> result =
                userProfileService.queryAddrList(account, condition, pageCountTemp, pageNumTemp);
            response = userProfileConvert.getQueryAddressListResponseModel2Rest(result);
        ...
        {
            LOGGER.error("queryAddrList method SDK error", e);
        ...
        {
            LOGGER.error("queryAddrList method error", e);
