 ...
 * @since  [产品/模块版本]
 */
@Path("ec/eserver/delGroup")
public class DelGroupResource
{
    /**
     * 日志对象
     */
    private static final Logger LOGGER = Logger.getLogger(DelGroupResource.class);
    ...
    public RestResponse<String> delGroup(GroupRequest request)
    {
        ...
        try
        {
            SDKResult<String> result = GROUP_SERVICE.delGroup(GROUP_RESOURCE_CONVERT.buildGroup(request));
        ...
        {
            LOGGER.error("delGroup method SDK error", e);
        ...
        {
            LOGGER.error("delGroup method error", e);
