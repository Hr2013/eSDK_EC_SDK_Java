...
import com.huawei.esdk.ec.north.rest.bean.SIPBatchAddRequest;
...
@Path("ec/bmu/batch_add_sip")
public class SIPAccountBatchResource
{
    private static final Logger LOGGER = Logger.getLogger(SIPAccountBatchResource.class);
    ...
    public SIPResponse addSIPs(SIPBatchAddRequest accts)
    {
        SIPResponse response = new SIPResponse();
        
        if (null == accts || null == accts.getSip())
        {
        ...
        {
            SDKErrorCode result =
                sipAccountService.addSIPs(accts.getUserId(),
                    accts.getNumStep(), accts.getUeStep(), accts.getAmount(),
                    sipAccountConvert.getSIPRest2Model(accts.getSip()));
        ...
        {
            LOGGER.error("addSIPs method SDK error", e);
        ...
        {
            LOGGER.error("addSIPs method error", e);
