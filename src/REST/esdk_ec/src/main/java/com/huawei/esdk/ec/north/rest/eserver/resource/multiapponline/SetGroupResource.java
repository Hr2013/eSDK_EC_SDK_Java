 ...
 * @since  [产品/模块版本]
 */
@Path("ec/eserver/setGroup")
public class SetGroupResource
{
    /**
     * 日志对象
     */
    private static final Logger LOGGER = Logger.getLogger(SetGroupResource.class);
    ...
    public RestResponse<String> setGroup(GroupRequest request)
    {
        ...
        try
        {
            SDKResult<String> result = GROUP_SERVICE.setGroup(GROUP_RESOURCE_CONVERT.buildGroup(request));
        ...
        {
            LOGGER.error("setGroup method SDK error", e);
        ...
        {
            LOGGER.error("setGroup method error", e);
